...
module.exports = [
  ...
  },
  {
    ...
    play: function (oppName) {
      ...
      this.game.message.dm(this.player, this.card.messages.reveal, opponent.name, opponent.hand.name, opponent.hand.number);
      this.game.message.dm(opponent, this.card.messages.reveal, this.player.name, this.player.hand.name, this.player.hand.number);
